...
class PluginState {
  ...
  logger: Logger;
  /** SnowLuma 客户端引用 */
  bot: SnowLumaApiClient | null = null;
  /** 机器人自身 QQ（用于转发节点头像） */
...
export let pluginState: PluginState | null = null;

/** 初始化全局状态。 */
export function initPluginState(config: PluginConfig, logger: Logger): PluginState {
