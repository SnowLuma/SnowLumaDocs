...
| Port   | Purpose                                        |
| ------ | ---------------------------------------------- |
| `6081` | noVNC (browser desktop for QR login; a random password is generated on first start and printed once) |
| `5099` | SnowLuma WebUI                                 |
| `3000` | OneBot HTTP (default)                          |
| `3001` | OneBot WebSocket (default)                     |

Raw VNC `5900` is not published by default. Map `127.0.0.1:5900:5900` yourself if you need it.
