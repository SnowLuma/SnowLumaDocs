...
Fastest path: the official installer, see [One-click install](/docs/guide/install). Image build scripts and Compose templates live in [`SnowLuma/SnowLuma.Docker.Framework`](https://github.com/SnowLuma/SnowLuma.Docker.Framework).
